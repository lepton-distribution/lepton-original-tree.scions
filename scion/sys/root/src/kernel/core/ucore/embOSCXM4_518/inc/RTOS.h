...
#define OS_DEBUG_HALT()                      { __asm volatile("bkpt #0"); }  // Use breakpoint instruction in OS_Error()
...
#define OS_INT_RestoreAll(p)    __set_PRIMASK(*(p))
 ...
 || (defined (__ARM8M_BASELINE__) && (__CORE__ == __ARM8M_BASELINE__))
  ...
  //
  #define OS_INT_Disable()      __set_BASEPRI(OS_IPL_THRESHOLD)
  ...
  //
    ...
    #define OS_INT_Disable()    { OS_U32 primask;                            \
                                  ...
                                  __disable_interrupt();                     \
                                  __set_BASEPRI(OS_IPL_THRESHOLD);           \
...
#define OS_VERSION_GENERIC  51803u
