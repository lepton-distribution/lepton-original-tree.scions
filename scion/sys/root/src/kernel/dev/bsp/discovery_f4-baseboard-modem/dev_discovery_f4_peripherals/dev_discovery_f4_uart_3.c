...
Global Declaration
=============================================*/
const char dev_discovery_f4_uart_3_name[]="ttys3\0";

int dev_discovery_f4_uart_3_load(void);
int dev_discovery_f4_uart_3_open(desc_t desc, int o_flag);
...
dev_map_t dev_discovery_f4_uart_3_map={
   dev_discovery_f4_uart_3_name,
   S_IFCHR,
   dev_discovery_f4_uart_3_load,
   dev_discovery_f4_uart_3_open,
...
extern board_stm32f4xx_uart_info_t discovery_f4_uart_3; 
...
{
  uart_irq_handler(&discovery_f4_uart_3.uart_descriptor);
}

void DMA1_Stream1_IRQHandler(void)
{
  uart_dma_irq_handler(&discovery_f4_uart_3.uart_descriptor);
}

/*-------------------------------------------
| Name:dev_discovery_f4_uart_3_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_discovery_f4_uart_3_load(void) {
   
   #if (__tauon_compiler__==__compiler_keil_arm__)
      memcpy(&discovery_f4_uart_3.uart_descriptor,&uart_descriptor,sizeof(_Uart_Descriptor));
   #endif
   discovery_f4_uart_3.uart_descriptor.board_uart_info=&discovery_f4_uart_3;
   discovery_f4_uart_3.desc_r=-1;
   discovery_f4_uart_3.desc_w=-1;
   discovery_f4_uart_3.baudrate=115200; //ublox ble NINA-B1:115200 //ublox modem: 19200  / ublox gnss: 9600
   
   return dev_stm32f4xx_uart_x_load(&discovery_f4_uart_3);
}
   
/*-------------------------------------------
| Name:dev_discovery_f4_uart_3_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_discovery_f4_uart_3_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_uart_x_open(desc, o_flag, &discovery_f4_uart_3);
}
