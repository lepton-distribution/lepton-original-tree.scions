...
Global Declaration
=============================================*/
const char dev_discovery_spi_2_name[]="spi2\0";

int dev_discovery_spi_2_load(void);
int dev_discovery_spi_2_open(desc_t desc, int o_flag);
...
dev_map_t dev_discovery_spi_2_map={
   dev_discovery_spi_2_name,
   S_IFCHR,
   dev_discovery_spi_2_load,
   dev_discovery_spi_2_open,
...
extern board_stm32f4xx_spi_info_t discovery_spi_2;
...
| See:
---------------------------------------------*/
static int dev_discovery_spi_2_load(void) {
   
   discovery_spi_2.spi_descriptor.board_spi_info=&discovery_spi_2;
   discovery_spi_2.desc_r=-1;
   discovery_spi_2.desc_w=-1;
   
   //__HAL_RCC_SPI5_CLK_ENABLE();
   
   return dev_stm32f4xx_spi_x_load(&discovery_spi_2);
}
   
/*-------------------------------------------
| Name:dev_discovery_spi_2_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_discovery_spi_2_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_spi_x_open(desc, o_flag, &discovery_spi_2);
}

/*============================================
| End of Source  : dev_discovery_spi_2.c
==============================================*/
