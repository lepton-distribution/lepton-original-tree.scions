...
//I2C ADDRESS 0x28H >> 2 = 0x50: mount /dev/te86bsd /dev/i2c1 /dev/press0 0x50
...
| See:
---------------------------------------------*/
int dev_te86bsd_close(desc_t desc){
  dev_te86bsd_info_t * p_dev_te86bsd_info = (dev_te86bsd_info_t*)ofile_lst[desc].p;
  //
  if(!p_dev_te86bsd_info)
   return -1;
...
| See:
---------------------------------------------*/
int dev_te86bsd_read(desc_t desc, char* buf,int size){
   dev_te86bsd_info_t * p_dev_te86bsd_info = (dev_te86bsd_info_t*)ofile_lst[desc].p;
   desc_t desc_i2c_read;
   //
   //
...
| See:
---------------------------------------------*/
int dev_te86bsd_write(desc_t desc, const char* buf,int size){
    return -1;
}
...
| See:
---------------------------------------------*/
int dev_te86bsd_seek(desc_t desc,int offset,int origin){
   return 0;
}
...
| See:
---------------------------------------------*/
int dev_te86bsd_ioctl(desc_t desc,int request,va_list ap) {
   dev_te86bsd_info_t * p_dev_te86bsd_info = (dev_te86bsd_info_t*)ofile_lst[desc].p;
