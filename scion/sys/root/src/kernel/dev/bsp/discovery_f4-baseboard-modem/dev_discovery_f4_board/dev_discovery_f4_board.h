...
typedef enum
{
  ...
  GPIO_ID_SENSOR_MOSI,
  GPIO_ID_SENSOR_SCLK,
  GPIO_ID_SENSOR_CLICK_420R_CS,
  GPIO_ID_SENSOR_CLICK_420R_EN,
...
#define GPIO_SENSOR_MISO     (&Gpio_Descriptor[GPIO_ID_SENSOR_MISO])
#define GPIO_SENSOR_MOSI     (&Gpio_Descriptor[GPIO_ID_SENSOR_MOSI])
#define GPIO_SENSOR_SCLK     (&Gpio_Descriptor[GPIO_ID_SENSOR_SCLK])
#define GPIO_SENSOR_CLICK_420R_CS     (&Gpio_Descriptor[GPIO_ID_SENSOR_CLICK_420R_CS])
#define GPIO_SENSOR_CLICK_420R_EN     (&Gpio_Descriptor[GPIO_ID_SENSOR_CLICK_420R_EN])
...
#define GPIO_OLED_MISO     (&Gpio_Descriptor[GPIO_ID_OLED_MISO])
