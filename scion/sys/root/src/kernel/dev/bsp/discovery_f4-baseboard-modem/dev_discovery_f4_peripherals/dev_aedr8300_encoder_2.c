...
extern rotary_encoder_info_t aedr8300_encoder_info_2;

const char dev_aedr8300_encoder_2_name[]="aedr83.2\0aedr_encoder_2\0";

static int dev_aedr8300_encoder_2_load(void);
static int dev_aedr8300_encoder_2_open(desc_t desc, int o_flag);

dev_map_t dev_aedr8300_encoder_2_map={
   dev_aedr8300_encoder_2_name,
   S_IFCHR,
   dev_aedr8300_encoder_2_load,
   dev_aedr8300_encoder_2_open,
...
/*-------------------------------------------
| Name:dev_aedr8300_encoder_2_load
| Description:
| Parameters:
| Return Type:
| Comments:
...
---------------------------------------------*/
static int dev_aedr8300_encoder_2_load(void){
  dev_rotary_encoder_x_load(&aedr8300_encoder_info_2);
  return 0;
}

/*-------------------------------------------
| Name:dev_aedr8300_encoder_2_open
| Description:
| Parameters:
| Return Type:
| Comments:
...
---------------------------------------------*/
static int dev_aedr8300_encoder_2_open(desc_t desc, int o_flag){
   dev_rotary_encoder_x_open(desc,o_flag, &aedr8300_encoder_info_2);
   return 0;
}
