...
Global Declaration
=============================================*/
const char dev_discovery_spi_1_name[]="spi1\0";

int dev_discovery_spi_1_load(void);
int dev_discovery_spi_1_open(desc_t desc, int o_flag);
...
dev_map_t dev_discovery_spi_1_map={
   dev_discovery_spi_1_name,
   S_IFCHR,
   dev_discovery_spi_1_load,
   dev_discovery_spi_1_open,
...
extern board_stm32f4xx_spi_info_t discovery_spi_1;
...
| See:
---------------------------------------------*/
static int dev_discovery_spi_1_load(void) {
   
   discovery_spi_1.spi_descriptor.board_spi_info=&discovery_spi_1;
   discovery_spi_1.desc_r=-1;
   discovery_spi_1.desc_w=-1;
   
   //__HAL_RCC_SPI5_CLK_ENABLE();
   
   return dev_stm32f4xx_spi_x_load(&discovery_spi_1);
}
   
/*-------------------------------------------
| Name:dev_discovery_spi_1_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_discovery_spi_1_open(desc_t desc, int o_flag) {
   return dev_stm32f4xx_spi_x_open(desc, o_flag, &discovery_spi_1);
}

/*============================================
| End of Source  : dev_discovery_spi_1.c
==============================================*/
