...
Global Declaration
=============================================*/
const char dev_stm32f469i_eval_i2c_1_name[]="i2c1\0";

int dev_stm32f469i_eval_i2c_1_load(void);
int dev_stm32f469i_eval_i2c_1_open(desc_t desc, int o_flag);
...
dev_map_t dev_stm32f469i_eval_i2c_1_map={
   dev_stm32f469i_eval_i2c_1_name,
   S_IFBLK,
   dev_stm32f469i_eval_i2c_1_load,
   dev_stm32f469i_eval_i2c_1_open,
...
static board_stm32f4xx_i2c_info_t stm32f469i_eval_i2c_1={0}; 
...
{
  HAL_DMA_IRQHandler(stm32f469i_eval_i2c_1.i2c_handle.hdmarx);
}
...
{
  HAL_DMA_IRQHandler(stm32f469i_eval_i2c_1.i2c_handle.hdmatx);
}



/*-------------------------------------------
| Name:dev_stm32f469i_eval_i2c_1_load
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_stm32f469i_eval_i2c_1_load(void) {
   GPIO_InitTypeDef  GPIO_InitStruct;
  
   //
   stm32f469i_eval_i2c_1.i2c_handle.Instance=I2C1;
   stm32f469i_eval_i2c_1.bus_speed = 100000L;
   stm32f469i_eval_i2c_1.own_address = 0xFE;
   //
   stm32f469i_eval_i2c_1.desc_r=-1;
   stm32f469i_eval_i2c_1.desc_w=-1;
   //
   
   stm32f469i_eval_i2c_1.i2c_rxtx_buffer_size = I2C1_RXTX_BUFFER_SIZE_MAX;
   stm32f469i_eval_i2c_1.p_i2c_rxtx_buffer = i2c1_rxtx_buffer;
   ...
   //
   return dev_stm32f4xx_i2c_x_load(&stm32f469i_eval_i2c_1);
}
   
/*-------------------------------------------
| Name:dev_stm32f469i_eval_i2c_1_open
| Description:
| Parameters:
| Return Type:
| Comments:
| See:
---------------------------------------------*/
static int dev_stm32f469i_eval_i2c_1_open(desc_t desc, int o_flag) {
   
   //DMA
   //
   stm32f469i_eval_i2c_1.tx_dma_stream=I2C1_TX_DMA_STREAM  ;
   stm32f469i_eval_i2c_1.tx_dma_stream_irq_no= I2C1_DMA_TX_IRQn ;
   stm32f469i_eval_i2c_1.tx_dma_channel=I2C1_TX_DMA_CHANNEL;
   //
   stm32f469i_eval_i2c_1.rx_dma_stream=I2C1_RX_DMA_STREAM;
   stm32f469i_eval_i2c_1.rx_dma_stream_irq_no=I2C1_DMA_RX_IRQn;
   stm32f469i_eval_i2c_1.rx_dma_channel=I2C1_RX_DMA_CHANNEL;
   //
   return dev_stm32f4xx_i2c_x_open(desc, o_flag, &stm32f469i_eval_i2c_1);
}

/*============================================
| End of Source  : dev_stm32f469i_eval_i2c_1.c
==============================================*/