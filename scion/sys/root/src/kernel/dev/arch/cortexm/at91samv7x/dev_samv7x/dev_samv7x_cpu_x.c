...
//IO
//RTC ALARM INTERRUPT
#define CHAUDRICONCEPT_BOARD_IO_RTC_ALARM_INT  {PIO_PA1, PIOA, ID_PIOA, PIO_INPUT, PIO_PULLUP|PIO_IT_FALL_EDGE}
static const Pin pins_io_rtc_alarm_int[] = {CHAUDRICONCEPT_BOARD_IO_RTC_ALARM_INT};
...
//accelerometer INT 1 (WKUP0)
#define CHAUDRICONCEPT_BOARD_IO_ACCELEROMETER_INT_1  {PIO_PA0, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
static const Pin pins_io_accelerometer_int_1[] = {CHAUDRICONCEPT_BOARD_IO_ACCELEROMETER_INT_1};

//accelerometer INT 2 (WKUP7)
#define CHAUDRICONCEPT_BOARD_IO_ACCELEROMETER_INT_2  {PIO_PA11, PIOA, ID_PIOA, PIO_INPUT, PIO_DEFAULT}
static const Pin pins_io_accelerometer_int_2[] = {CHAUDRICONCEPT_BOARD_IO_ACCELEROMETER_INT_2};
...
#define WKUP_IDX_EXTERNAL_ACCEL_INT1            0
#define WKUP_IDX_EXTERNAL_ACCEL_INT2            7

const uint32_t gWakeUpPinId = (1 << WKUP_IDX_EXTERNAL_RTC_PIN) 
| (1 << WKUP_IDX_EXTERNAL_WAKEUP_SPARE_PIN) 
| (1 << WKUP_IDX_EXTERNAL_INSERT_PIN)
| (1 << WKUP_IDX_EXTERNAL_ACCEL_INT1)
| (1 << WKUP_IDX_EXTERNAL_ACCEL_INT2);
...
COMPILER_SECTION("bram_region")
COMPILER_ALIGNED(32) uint32_t backup_memory_binary_array[512/sizeof(uint32_t)];
...
static void EnterBackupMode(void){
   ...
   //
   if(PIO_Get(&pins_io_rtc_alarm_int[0])) //==1 wait falling edge: 1 to 0
      msk_wuir =  msk_wuir;
   else //==0 wait rising edge: 0 to 1
      msk_wuir = ( (1 << WKUP_IDX_EXTERNAL_RTC_PIN) << 16 ) | msk_wuir;
	//
   ...
   //
   if(PIO_Get(&pins_io_accelerometer_int_1[0])) //==1 wait falling edge on insert: 1 to 0
      msk_wuir =  msk_wuir;
   else //==0 wait rising edge on  insert: 0 to 1
      msk_wuir = ( (1 << WKUP_IDX_EXTERNAL_ACCEL_INT1) << 16 ) | msk_wuir;
   //
   if(PIO_Get(&pins_io_accelerometer_int_2[0])) //==1 wait falling edge on insert: 1 to 0
      msk_wuir =  msk_wuir;
   else //==0 wait rising edge on  insert: 0 to 1
      msk_wuir = ( (1 << WKUP_IDX_EXTERNAL_ACCEL_INT2) << 16 ) | msk_wuir;
   //
