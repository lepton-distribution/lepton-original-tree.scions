...
/* USER CODE BEGIN PV */
#if defined(USE_DEV_BSP_RADIO_DRIVER_IF)
   static dev_stm32wlxx_bsp_radio_if_t* g_p_dev_stm32wlxx_bsp_radio_if=(dev_stm32wlxx_bsp_radio_if_t*)0;
#endif
/* USER CODE END PV */
...
int32_t RBI_Init(void)
{
  ...
  g_p_dev_stm32wlxx_bsp_radio_if = get_stm32wlxx_bsp_radio_if();
  //
  return g_p_dev_stm32wlxx_bsp_radio_if->pfn_bsp_radio_init();
  
#elif defined(USE_BSP_DRIVER)
...
int32_t RBI_DeInit(void)
{
  ...
  /* USER CODE END RBI_DeInit_1 */
   ...
   if(g_p_dev_stm32wlxx_bsp_radio_if==(dev_stm32wlxx_bsp_radio_if_t*)0){
      return 0;
   }
   //
   return g_p_dev_stm32wlxx_bsp_radio_if->pfn_bsp_radio_deinit();
...
int32_t RBI_ConfigRFSwitch(RBI_Switch_TypeDef Config)
{
  ...
  /* USER CODE END RBI_ConfigRFSwitch_1 */
   ...
   //
   return g_p_dev_stm32wlxx_bsp_radio_if->pfn_bsp_radio_config_RF_switch(Config);
...
int32_t RBI_GetTxConfig(void)
{
  ...
  /* USER CODE END RBI_GetTxConfig_1 */
   ...
   //
   return g_p_dev_stm32wlxx_bsp_radio_if->pfn_bsp_radio_init_get_tx_config();
...
int32_t RBI_IsTCXO(void)
{
  ...
  /* USER CODE END RBI_IsTCXO_1 */
   ...
   //
   return g_p_dev_stm32wlxx_bsp_radio_if->pfn_bsp_radio_is_TCXO();
...
int32_t RBI_IsDCDC(void)
{
  ...
  /* USER CODE END RBI_IsDCDC_1 */
   ...
   //
   return g_p_dev_stm32wlxx_bsp_radio_if->pfn_bsp_radio_is_DCDC();
...
int32_t RBI_GetRFOMaxPowerConfig(RBI_RFOMaxPowerConfig_TypeDef Config)
{
  ...
  /* USER CODE END RBI_GetRFOMaxPowerConfig_1 */
   ...
   //
   return g_p_dev_stm32wlxx_bsp_radio_if->pfn_bsp_radio_is_get_RFO_max_power_config(Config);
