...
/* MEMP_NUM_TCP_PCB: the number of simulatenously active TCP
   connections. */
#define MEMP_NUM_TCP_PCB        4 //(24 lepton modifs) //default 5
...
#define MEMP_NUM_NETBUF         64  //64 lepton modifs) //default 2
/* MEMP_NUM_NETCONN: the number of struct netconns. */
#define MEMP_NUM_NETCONN        10 //10
